...
@interface MailboxesController : NSObject
{
    ...
    NSMutableDictionary *_checkedInConverters;
    id _menuEnabler;
...
- (int)_loadBundlesFromPath:(id)fp8 ignoredBundlePaths:(id)fp12;
- (void)_loadBundles;
...
+ (id)sharedManager;
- (id)_setupAccountType:(int)fp8 hostname:(id)fp12 username:(id)fp16 password:(id)fp20 emailAddresses:(id)fp24 fullUserName:(id)fp28 smtp:(id)fp32 outlookWebSever:(id)fp36 synchronize:(BOOL)fp40;
